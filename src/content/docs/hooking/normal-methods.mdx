...
:::danger
Getter methods are usually very small, and small methods often suffer from inlining.
This same issue is more closely discussed in [Hooking Iterators # 1 Wrap The Enumerator](/hooking/iterators#1-wrap-the-enumerator).
:::
